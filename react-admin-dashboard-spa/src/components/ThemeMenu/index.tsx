...
const ThemeMenu: React.FC = () => {
    ...
    const menu_ref = useRef(null as any)
    const menu_toggle_ref = useRef(null as any)
    ...
    const setMode = (mode: { id: any; name?: string; background?: string; class: any }) => {
        setcurrMode(mode.id)
        localStorage.setItem('themeMode', mode.class)
        dispatch(ThemeAction.setMode(mode.class))
    }

    const setColor = (color: { id: any; name?: string; background?: string; class: any }) => {
